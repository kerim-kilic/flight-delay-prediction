...
spark_data <- spark_data %>%
  select(-carrier_delay,-weather_delay,-nas_delay,-security_delay,-late_aircraft_delay,-origin,-destination)
...
```{r}
### remove the classification variable delay, do some dplyr manipulation
regr_data <- spark_data_one_hot_encoded %>%
  select(-delay)

### Split in train and test datasets
train_data_regr <- regr_data %>%
  sample_frac(0.008)
test_data_regr <- regr_data %>%
  sample_frac(0.002)
