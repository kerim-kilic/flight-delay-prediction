...
colnames(gbm_metrics_test) <- c("metric_names", "GBM_test")
```
...
colnames(dl_metrics_test) <- c("metric_names", "DL_test")
```
...
final_summary_test <- gbm_metrics_test %>%
  append(data.frame(dl_metrics_test$DL_test))
