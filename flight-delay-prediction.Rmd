...
classification_results <- data.frame(model_type, train_time, tuned_results_train, tuned_results_test, tuned_roc_test)
colnames(classification_results) <- c("model type", "train time", "Acc. train set", "Acc. test set", "ROC test set")
classification_results
```
