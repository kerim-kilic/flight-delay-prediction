...
# Weather code in development right here
...
Using the worldmet package

```{r}
library(worldmet)
# getMeta(site = "HARTSFIELD-JACKSON ATLANTA")
# getMeta(site = "Denver")
# getMeta(site = "O'Hare")
# getMeta(site = "Los Angeles")
# getMeta(site = "Dallas")
# getMeta(site = "San Francisco")
# getMeta(site = "Phoenix")
# getMeta(site = "MCCARRAN INTERNATIONAL AIRPORT")
# getMeta(site = "seattle")
# getMeta(site = "Minneapolis")
...
# flight_data <- main_pipeline(raw_data)
# joined_data <- left_join(flight_data, weather_data,by=c("origin"="origin","date"="date"))
# 
...
#          origin,
#          delay,delay_time,
#          latitude,longitude,elev,ws,wd,air_temp,atmos_pres,visibility,dew_point)
