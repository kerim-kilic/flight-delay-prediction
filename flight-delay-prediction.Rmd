...
h2o_classification_split <- create_train_test_split(data = class_delay_pipeline(raw_data),
                                                    sample_size = 100000,
                                                    ratio = 0.6,
...
h2o_numerical_split <- create_train_test_split(data = numer_delay_pipeline(raw_data),
                                                    sample_size = 100000,
                                                    ratio = 0.6,
                                                    type = "h2o_numerical",
                                                    hc = hc)
