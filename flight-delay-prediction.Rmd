...
one_hot_encoding_pipeline <- . %>% 
  ft_string_indexer(input_col = "origin", output_col = "origin_ind") %>%
  ft_string_indexer(input_col = "destination", output_col = "destination_ind") %>%
  ft_string_indexer(input_col = "carrier", output_col = "carrier_ind") %>%
  ft_string_indexer(input_col = "planned_arrival_local_hour", output_col = "planned_arrival_local_hour_ind") %>%
  ft_string_indexer(input_col = "planned_departure_local_hour", output_col = "planned_departure_local_hour_ind") %>%
  ft_one_hot_encoder(input_cols = c("origin_ind","destination_ind","carrier_ind",
                                    "planned_arrival_local_hour_ind","planned_departure_local_hour_ind"),
                     output_cols = c("origin_out","destination_out","carrier_out",
                                     "planned_arrival_local_hour_out","planned_departure_local_hour_out"))%>%
  select(-origin,-destination,-carrier,-planned_arrival_local_hour,-planned_departure_local_hour) %>%
  ft_vector_assembler(input_cols = c("origin_out","destination_out","carrier_out",
                                     "planned_arrival_local_hour_out","planned_departure_local_hour_out"),
