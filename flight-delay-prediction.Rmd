...
main_pipeline <- .%>%
  ...
  select(date,quarter,month,day_of_month,day_of_week,hour_of_day,minutes_of_hour,
...
weather_data <- weather_data %>%
  ...
  summarise(across(c(ws,
                     ...
                     visibility, dew_point), mean))
weather_data2 <- weather_data
###
colnames(weather_data) <- c("origin", "date", "origin_ws", "origin_wd", "origin_air_temp", "origin_atmos_pres", "origin_visibility", "origin_dew_point")
colnames(weather_data2) <- c("destination", "date", "destination_ws", "destination_wd", 
                             "destination_air_temp", "destination_atmos_pres", "destination_visibility", "destination_dew_point")
###
...
class_data <- ft_one_hot_encoder(class_data_tmp, input_cols = c("origin_ind","destination_ind"), output_cols = c("origin_out","destination_out")) %>%
...
numer_data <- ft_one_hot_encoder(numer_data_tmp, input_cols = c("origin_ind","destination_ind"), output_cols = c("origin_out","destination_out")) %>%
  select(-origin,-destination)
###
...
# train_data <- left_join(train_data, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-destination,-date)

test_data <- classification_split$test_data
# test_data <- left_join(test_data, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-destination,-date)
...
# train_data_regr <- left_join(train_data_regr, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-destination,-date)

test_data_regr <- numerical_split$test_data
# test_data_regr <- left_join(test_data_regr, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-destination,-date)
```
...
# valid_data_h2o <- h2o.merge(valid_data_h2o, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-date)
test_data_h2o  <- h2o_classification_split[[3]]
# test_data_h2o <- h2o.merge(test_data_h2o, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-date)
...
# train_data_regr_h2o <- h2o.merge(train_data_regr_h2o, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-date)
valid_data_regr_h2o <- h2o_numerical_split[[2]]
# valid_data_regr_h2o <- h2o.merge(valid_data_regr_h2o, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-date)
test_data_regr_h2o  <- h2o_numerical_split[[3]]
# test_data_regr_h2o <- h2o.merge(test_data_regr_h2o, weather_data,by=c("origin"="origin","date"="date")) %>%
#   select(-origin,-date)
###########
rm(raw_data)
```
